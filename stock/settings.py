...
print(load_environment_file('.environment.ini'))
...
if DEBUG:
    STATIC_ROOT = os.path.join(os.path.dirname(BASE_DIR),"stock","static","static-only")
    STATICFILES_DIRS = ( os.path.join(os.path.dirname(BASE_DIR),"stock","static","static"),)
